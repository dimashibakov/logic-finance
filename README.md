...
2. Коннектор Teller (US) при необходимости.
...
## ⚠️ Безопасность
Supabase Auth (magic link) + RLS: данные доступны только залогиненному owner. Публичный anon-ключ без сессии не читает таблицы.
